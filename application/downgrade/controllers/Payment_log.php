        ...
        if ($this->form_validation->run()) {
            ...
            if (isset($old_payment_id)) {
                ...
                foreach ($old_payment_id as $k => $v) {
                    $this->Payment_model->updatePayment($old_paying_amount[$count], $v);
                    $total_old_fee = $total_old_fee + $old_paying_amount[$count];
                }
            }
...
//        var_dump($data);die;
    ...
    function view_and_msg($payment_log_id) {
        ...
        $data['fee_data'] = $this->Fee_model->get_fee($record->class_id);
//        var_dump($data);die;
        $data['_view'] = 'payment_log/view_and_msg';
        $this->load->view('layouts/main', $data);
    }
