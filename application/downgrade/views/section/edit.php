			...
			<div class="card-body">
				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="class_id" class="form-control">
								...
								{
									$selected = ($clas['class_id'] == $section['class_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="teacher_id" class="form-control">
								...
								{
									$selected = ($teacher['teacher_id'] == $section['teacher_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
                                                    <input type="text" name="section_name" value="<?php echo ($this->input->post('section_name') ? $this->input->post('section_name') : $section['section_name']); ?>" class="form-control" id="section_name" placeholder="Section Name" />
                                                    <i class="form-group__bar"></i>
