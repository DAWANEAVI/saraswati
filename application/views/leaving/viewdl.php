...
<td colspan="2" class="text-center" style="line-height:1.5; padding:0px;">
    ...
    <h6 style="line-height:0.8;" class="text-center;">E-mail: <span class="line"><?= 'saraswatips@gmail.com' ?></span></h6>
        ...
        <tr>
            <td colspan="2">Phone No. : <span class="line"><?= '9723663111' ?></span></td>
            <td colspan="2"class="text-right"> E-mail. : <span class="line"><?= 'spemsyavatmal@yahoo.com' ?></span></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2"class="text-right"> <b>General /Register No.</b><span class="line"><?php echo ($student->registration_no) ?></span></span></td>
        </tr>
        
        <tr>
            <td colspan="2"><b>School Recog. No  : NPS 1706/ (114/2006)/ Ps-3</b></td>
            <td colspan="2" class="text-right">Medium : English</td>
        </tr>
      
        <tr>
            <td colspan="2"><b>UDISE NO.27141506321</b></td>
            <td colspan="1" class="text-center"> Board : State Board</td>
            <td colspan="2" class="text-right"> Concerned No. : 7517068111</td>
