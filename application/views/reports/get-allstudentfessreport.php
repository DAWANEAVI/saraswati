...
<div class="card-body">
    ...
    ?>
    <h3 class="box-title">All Students Fees Report</h3>
    <table id="data-table" class="table table-bordered bg-white">
        <thead class="thead-default">
            <tr>
                ...
                <th>Rem. Term Fees</th>
                <th>Rem. Exam Fees</th>
                <th>Rem. Sport Fees</th>
                <th>Rem. Miscel. Fees</th>
                <th>Total</th>
                <th>Paid</th>
                <th>Balance</th>
        ...
        foreach ($result as $s) {
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo $s['education_fee']; ?></td>
                    <td><?php echo $s['term_fee']; ?></td>
                    <td><?php echo $s['exam_fee']; ?></td>
                    <td><?php echo $s['sport_fee']; ?></td>
                    <td><?php echo $s['miscellaneous_fee']; ?></td>
